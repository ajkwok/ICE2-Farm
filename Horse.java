public class Horse
{
   ...
   private int beenCombed;

   Horse(String colored, int feed, int wash, int exercise)
   {
      color = colored;
      needsFed = feed;
      needsWashed = wash;
   ...
   public void setCombed(int combed)
   {
      beenCombed = combed;
   }
   public void done()
   {
      System.out.println("The horse is " + color + " and has been fed " + beenFed
                         + " times, washed " + beenWashed + " times, exercised "
                         + beenExercised + " times, and combed " + beenCombed
                         + " times.");
   }
}
